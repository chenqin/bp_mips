 ...
 *
 * GUI can be used as either an applet or an application.  If used as an applet,
 * the recommended minimum size for the applet tag is 500 by 500.
 * @see ListBoxes
 * @see Stages
 * @see UI
 * @see Instruction
...
RUNLOOP:		if(OK)
	...
	/**
	 * Sets the Enabled condition of components in the UI to the value
	 * of cond.
	 * @see UI
	*/
